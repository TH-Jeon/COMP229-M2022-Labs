                            ...
                            <div className="form-group">
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        placeholder="First Name" value = { FirstName } onChange = { onChangeFirstName } required />
                                    </div>

                                    <div className="col-md-6">
                                        <input className="form-control" type="text" name="lastName" id="lastName" 
                                        placeholder="Last Name" value = { LastName } onChange = { onChangeLastName } required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        required value = { EmailAddress } onChange = { onChangeEmailAddress } placeholder="Email" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-group mt-4">
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        required value = { username } onChange = { onChangeUsername } placeholder="Username" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        required value = { password } onChange = { onChangePassword } placeholder="Password" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        required value = { confirmPassword } onChange = { onChangeConfirmPassword } 
