            ...
            <div className="row justify-content-lg-center g-3">
                <form className="col-lg-6 col-md-10 col-sm-10">
                    <div className="input-group mb-3">
                        ...
                        <input id="fullName" name="fullName" type="text" className="form-control" aria-label="Full Name" 
                        aria-describedby="Full Name Input" required/>
                    </div>

                    <div className="input-group mb-3">
                        <span className="input-group-text">Contact Number</span>
                        <input id="contactNumber" name="contactNumber" type="tel" className="form-control" aria-label="Contact Number" 
                        aria-describedby="Contact Number Input" required/>
                    </div>

                    <div className="input-group mb-3">
                        <span className="input-group-text">Email Address</span>
                        <input id="emailAddress" name="emailAddress" type="email" className="form-control" aria-label="Email Address" 
                        aria-describedby="Email Address Input" required/>
                    </div>
